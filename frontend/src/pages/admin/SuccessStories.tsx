  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-warmgray-800 dark:text-warmgray-200">Success Stories</h1>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {stories.map((story) => (
            <div key={story.id} className="bg-white dark:bg-surface-dark-raised rounded-xl border border-warmgray-200 dark:border-surface-dark-border p-5">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-red-50 rounded-lg p-3">
                      ...
                      <p className="text-sm text-warmgray-700 dark:text-warmgray-300">{story.before_text}</p>
                    </div>
                    <div className="bg-green-50 rounded-lg p-3">
                      <p className="text-xs font-semibold text-green-700 mb-1">After</p>
                      <p className="text-sm text-warmgray-700 dark:text-warmgray-300">{story.after_text}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 px-3 py-1.5 text-xs font-semibold rounded-lg transition-colors ${
                      story.featured
                        ...
                        : 'bg-gray-100 dark:bg-surface-dark-border text-warmgray-700 dark:text-warmgray-300 hover:bg-gray-200'
                    }`}
                  >
