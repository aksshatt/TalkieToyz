    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">{totalCount} total stories</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {stories.map((story) => (
            <div key={story.id} className="bg-white rounded-xl border border-gray-200 p-5">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    <span className="font-bold text-gray-900">{story.child_name}</span>
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-red-50 rounded-lg p-3">
                      ...
                      <p className="text-sm text-gray-700">{story.before_text}</p>
                    </div>
                    <div className="bg-green-50 rounded-lg p-3">
                      <p className="text-xs font-semibold text-green-700 mb-1">After</p>
                      <p className="text-sm text-gray-700">{story.after_text}</p>
                    </div>
                  </div>
                </div>
