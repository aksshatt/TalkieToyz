...
const BlogPostDetail = () => {
  ...
  if (loading) {
    return (
      <Layout>
        <div className="min-h-screen bg-cream-light dark:bg-surface-dark flex items-center justify-center">
  ...
  if (!post) {
    return (
      <Layout>
        <div className="min-h-screen bg-cream-light dark:bg-surface-dark flex items-center justify-center">
          <div className="text-center">
            <p className="text-2xl font-bold text-warmgray-700 dark:text-warmgray-300 mb-4">Post not found</p>
  ...
  return (
    <Layout>
          ...
          <div className="relative h-[420px] md:h-[520px]">
            ...
            <div className="absolute top-6 left-4 md:left-8">
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
                <Link to="/blog"
                  className="inline-flex items-center gap-2 bg-white dark:bg-surface-dark-raised/20 backdrop-blur-sm text-white font-semibold px-4 py-2 rounded-full hover:bg-white dark:hover:bg-surface-dark-raised/30 transition-all text-sm border border-white/30">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-white">
              {post.category && (
                <motion.span initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }}
                  className="inline-block bg-white dark:bg-surface-dark-raised/20 text-white text-xs font-bold px-3 py-1 rounded-full mb-4 uppercase tracking-wide">
                  {post.category_display_name || post.category}
                </motion.span>
              )}
      ...
      {/* Main Content */}
      <div className="bg-cream-light dark:bg-surface-dark min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-10">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-surface-dark-raised rounded-3xl shadow-soft-xl overflow-hidden mb-8"
          >
            {/* Author + Share bar */}
            <div className="flex flex-wrap items-center justify-between gap-4 px-8 py-5 border-b border-warmgray-100 dark:border-surface-dark-border bg-warmgray-50 dark:bg-surface-dark/50">
              {/* Author pill */}
          ...
          {post.allow_comments && (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-[var(--font-family-fun)] font-bold text-warmgray-900 dark:text-warmgray-100">
                  Discussion
                </h2>
