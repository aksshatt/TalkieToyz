  ...
  return (
    <div className="min-h-screen py-12 px-4">
      <motion.div
        ...
        className="max-w-4xl mx-auto bg-white dark:bg-surface-dark-raised rounded-3xl shadow-soft p-8 md:p-12"
      >
        ...
        <div className="prose prose-warmgray max-w-none text-warmgray-700 dark:text-warmgray-300 space-y-6">
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">2. Services Provided</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">3. Bookings &amp; Appointments</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">4. Payments</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">5. Use of Platform</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">6. Medical Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">7. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">8. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">9. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">10. Contact</h2>
            <p>
