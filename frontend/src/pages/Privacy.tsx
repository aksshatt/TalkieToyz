    ...
    <div className="min-h-screen py-12 px-4">
      ...
      >
        ...
        <div className="prose prose-warmgray max-w-none text-warmgray-700 dark:text-warmgray-300 space-y-6">
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">2. How We Use Information</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">3. Child Data Protection</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">4. Sharing of Information</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">5. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">6. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">7. Your Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">8. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">9. Third-Party Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-warmgray-900 dark:text-warmgray-100 mb-2">10. Changes &amp; Contact</h2>
            <p>
