        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4">
            ...
            <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.96 }}>
              <Link
                to="/assessments"
                className="inline-flex items-center justify-center px-8 py-4 bg-white dark:bg-surface-dark-raised/95 backdrop-blur-sm hover:bg-white dark:hover:bg-surface-dark-raised text-black dark:text-warmgray-100 font-bold text-lg rounded-full border-2 border-white shadow-soft hover:shadow-lg transition-colors duration-300"
              >
