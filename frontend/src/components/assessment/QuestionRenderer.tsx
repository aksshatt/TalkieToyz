        ...
        <button
          ...
          className={`w-full p-4 rounded-lg border-2 transition-all font-semibold ${
            answer === 'no'
              ...
              : 'border-warmgray-300 dark:border-surface-dark-border hover:border-coral hover:bg-coral-light/30'
          }`}
        >
          No
        </button>
  ...
  if (question.type === 'text') {
    return (
      <textarea
        ...
        className="w-full p-4 border-2 border-warmgray-300 dark:border-surface-dark-border rounded-lg focus:border-teal focus:ring-2 focus:ring-teal/20 transition-all"
        rows={4}
