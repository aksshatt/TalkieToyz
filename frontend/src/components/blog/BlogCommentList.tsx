...
const BlogCommentList = ({ comments }: BlogCommentListProps) => {
  if (comments.length === 0) {
    return (
      <div className="bg-white dark:bg-surface-dark-raised rounded-2xl shadow-soft border border-warmgray-100 dark:border-surface-dark-border p-8 text-center">
      ...
      {comments.map((comment, i) => {
        ...
        return (
          <motion.div
            ...
            className="bg-white dark:bg-surface-dark-raised rounded-2xl shadow-soft border border-warmgray-100 dark:border-surface-dark-border p-5"
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-warmgray-700 dark:text-warmgray-300 text-sm leading-relaxed">{comment.comment_text}</p>
              </div>
            </div>
          </motion.div>
        );
